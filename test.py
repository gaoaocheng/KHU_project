...
def parse_args():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='D:/khu_project/checkpoint/generator_Hayao_weight/',
                        help='Directory name to save the checkpoints')
    parser.add_argument('--test_dir', type=str, default=r'D:\khu_project\dataset\test\HR_photo',
